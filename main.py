...
image_scale = None  # line №53
image_size = None  # would be 1:1 : [16, 16], [32, 32], [9, 9]...
...
for line in image_lines:
    ...
    # line = "def black = #000000"
        ...
        image_colour_vars |= colour_dict  # {'black': '#000000'} + {'green': '#01a205'} = {'black': '#000000', 'green': '#01a205'} (|= = dict + dict)
